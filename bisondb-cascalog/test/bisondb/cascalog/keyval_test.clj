(ns bisondb.cascalog.keyval-test
  (:use bisondb.cascalog.keyval
        bisondb.cascalog.core
...
(defmacro with-jcascalog-kv-tap
  [[sym shard-count & opts] & body]
  `(test/with-fs-tmp [fs# tmp#]
     (let [~sym (bisondb.jcascalog.BDB/makeKeyValTap
                  tmp#
...
(tabular
 (fact
   "BisonDB taps should be usable via JCascalog"
