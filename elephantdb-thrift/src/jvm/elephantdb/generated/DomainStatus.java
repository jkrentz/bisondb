...
public class DomainStatus extends org.apache.thrift.TUnion<DomainStatus, DomainStatus._Fields> {
  ...
  static {
    ...
    tmpMap.put(_Fields.LOADING, new org.apache.thrift.meta_data.FieldMetaData("loading", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
    ...
    tmpMap.put(_Fields.SHUTDOWN, new org.apache.thrift.meta_data.FieldMetaData("shutdown", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public DomainStatus(_Fields setField, java.lang.Object value) {
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      case READY:
        ...
        throw new java.lang.ClassCastException("Was expecting value of type ReadyStatus for field 'ready', but got " + value.getClass().getSimpleName());
      case LOADING:
        if (value instanceof LoadingStatus) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type LoadingStatus for field 'loading', but got " + value.getClass().getSimpleName());
      case FAILED:
        if (value instanceof FailedStatus) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type FailedStatus for field 'failed', but got " + value.getClass().getSimpleName());
      case SHUTDOWN:
        if (value instanceof ShutdownStatus) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type ShutdownStatus for field 'shutdown', but got " + value.getClass().getSimpleName());
      default:
  ...
  public ReadyStatus get_ready() {
    if (getSetField() == _Fields.READY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'ready' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public LoadingStatus get_loading() {
    if (getSetField() == _Fields.LOADING) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'loading' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public FailedStatus get_failed() {
    if (getSetField() == _Fields.FAILED) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'failed' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public ShutdownStatus get_shutdown() {
    if (getSetField() == _Fields.SHUTDOWN) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'shutdown' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
