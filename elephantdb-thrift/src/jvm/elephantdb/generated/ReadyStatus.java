...
public class ReadyStatus implements org.apache.thrift.TBase<ReadyStatus, ReadyStatus._Fields>, java.io.Serializable, Cloneable, Comparable<ReadyStatus> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ReadyStatusStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ReadyStatusTupleSchemeFactory();

  private @org.apache.thrift.annotation.Nullable LoadingStatus update_status; // optional
  ...
  private static final _Fields optionals[] = {_Fields.UPDATE_STATUS};
  ...
  public void set_update_status(@org.apache.thrift.annotation.Nullable LoadingStatus update_status) {
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((is_set_update_status()) ? 131071 : 524287);
    if (is_set_update_status())
      hashCode = hashCode * 8191 + update_status.hashCode();
  ...
  public int compareTo(ReadyStatus other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(is_set_update_status()).compareTo(other.is_set_update_status());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_update_status()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.update_status, other.update_status);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ReadyStatus(");
    boolean first = true;
  ...
  private static class ReadyStatusStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ReadyStatusStandardScheme getScheme() {
      return new ReadyStatusStandardScheme();
    }
  }

  private static class ReadyStatusStandardScheme extends org.apache.thrift.scheme.StandardScheme<ReadyStatus> {
  ...
  private static class ReadyStatusTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ReadyStatusTupleScheme getScheme() {
      return new ReadyStatusTupleScheme();
    }
  }

  private static class ReadyStatusTupleScheme extends org.apache.thrift.scheme.TupleScheme<ReadyStatus> {
