...
class Status(object):
    ...
    def validate(self):
        if self.domain_statuses is None:
            raise TProtocolException(message='Required field domain_statuses is unset!')
        return
...
class DomainSpec(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.coordinator = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
                    self.shard_scheme = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.coordinator is not None:
            ...
            oprot.writeString(self.coordinator.encode('utf-8') if sys.version_info[0] == 2 else self.coordinator)
            oprot.writeFieldEnd()
        if self.shard_scheme is not None:
            oprot.writeFieldBegin('shard_scheme', TType.STRING, 3)
            oprot.writeString(self.shard_scheme.encode('utf-8') if sys.version_info[0] == 2 else self.shard_scheme)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        if self.num_shards is None:
            raise TProtocolException(message='Required field num_shards is unset!')
        if self.coordinator is None:
            raise TProtocolException(message='Required field coordinator is unset!')
        if self.shard_scheme is None:
            raise TProtocolException(message='Required field shard_scheme is unset!')
        return
...
class DomainMetaData(object):
    ...
    def validate(self):
        if self.remote_version is None:
            raise TProtocolException(message='Required field remote_version is unset!')
        if self.local_version is None:
            raise TProtocolException(message='Required field local_version is unset!')
        if self.shard_set is None:
            raise TProtocolException(message='Required field shard_set is unset!')
        if self.domain_spec is None:
            raise TProtocolException(message='Required field domain_spec is unset!')
        return
...
class MetaData(object):
    ...
    def validate(self):
        if self.domain_metadatas is None:
            raise TProtocolException(message='Required field domain_metadatas is unset!')
        return
...
class HostsDownException(TException):
    ...
    def validate(self):
        if self.hosts is None:
            raise TProtocolException(message='Required field hosts is unset!')
        return
...
class InvalidConfigurationException(TException):
    ...
    def validate(self):
        if self.mismatched_domains is None:
            raise TProtocolException(message='Required field mismatched_domains is unset!')
        if self.port_changed is None:
            raise TProtocolException(message='Required field port_changed is unset!')
        if self.hosts_changed is None:
            raise TProtocolException(message='Required field hosts_changed is unset!')
        return
...
all_structs.append(LoadingStatus)
LoadingStatus.thrift_spec = (
)
all_structs.append(ReadyStatus)
ReadyStatus.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'update_status', [LoadingStatus, None], None, ),  # 1
)
all_structs.append(FailedStatus)
FailedStatus.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'error_message', 'UTF8', None, ),  # 1
)
all_structs.append(ShutdownStatus)
ShutdownStatus.thrift_spec = (
)
all_structs.append(DomainStatus)
DomainStatus.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'ready', [ReadyStatus, None], None, ),  # 1
    (2, TType.STRUCT, 'loading', [LoadingStatus, None], None, ),  # 2
    (3, TType.STRUCT, 'failed', [FailedStatus, None], None, ),  # 3
    (4, TType.STRUCT, 'shutdown', [ShutdownStatus, None], None, ),  # 4
)
all_structs.append(Status)
Status.thrift_spec = (
    None,  # 0
    (1, TType.MAP, 'domain_statuses', (TType.STRING, 'UTF8', TType.STRUCT, [DomainStatus, None], False), None, ),  # 1
)
all_structs.append(DomainSpec)
DomainSpec.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'num_shards', None, None, ),  # 1
    (2, TType.STRING, 'coordinator', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'shard_scheme', 'UTF8', None, ),  # 3
)
all_structs.append(DomainMetaData)
DomainMetaData.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'remote_version', None, None, ),  # 1
    (2, TType.I64, 'local_version', None, None, ),  # 2
    (3, TType.SET, 'shard_set', (TType.I64, None, False), None, ),  # 3
    (4, TType.STRUCT, 'domain_spec', [DomainSpec, None], None, ),  # 4
)
all_structs.append(MetaData)
MetaData.thrift_spec = (
    None,  # 0
    (1, TType.MAP, 'domain_metadatas', (TType.STRING, 'UTF8', TType.STRUCT, [DomainMetaData, None], False), None, ),  # 1
)
all_structs.append(DomainNotFoundException)
DomainNotFoundException.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'domain', 'UTF8', None, ),  # 1
)
all_structs.append(DomainNotLoadedException)
DomainNotLoadedException.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'domain', 'UTF8', None, ),  # 1
)
all_structs.append(HostsDownException)
HostsDownException.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'hosts', (TType.STRING, 'UTF8', False), None, ),  # 1
)
all_structs.append(InvalidConfigurationException)
InvalidConfigurationException.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'mismatched_domains', (TType.STRING, 'UTF8', False), None, ),  # 1
    (2, TType.BOOL, 'port_changed', None, None, ),  # 2
    (3, TType.BOOL, 'hosts_changed', None, None, ),  # 3
)
all_structs.append(WrongHostException)
WrongHostException.thrift_spec = (
)
