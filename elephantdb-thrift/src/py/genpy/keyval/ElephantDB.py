...
class Processor(elephantdb.ElephantDBShared.Processor, Iface, TProcessor):
    ...
    def process_get(self, seqid, iprot, oprot):
        ...
        try:
            ...
            raise
        except elephantdb.ttypes.DomainNotFoundException as dnfe:
            msg_type = TMessageType.REPLY
            result.dnfe = dnfe
        except elephantdb.ttypes.HostsDownException as hde:
            msg_type = TMessageType.REPLY
            result.hde = hde
        except elephantdb.ttypes.DomainNotLoadedException as dnle:
            msg_type = TMessageType.REPLY
            result.dnle = dnle
    ...
    def process_directMultiGet(self, seqid, iprot, oprot):
        ...
        try:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("directMultiGet", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
get_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [elephantdb.ttypes.Value, None], None, ),  # 0
    (1, TType.STRUCT, 'dnfe', [elephantdb.ttypes.DomainNotFoundException, None], None, ),  # 1
    (2, TType.STRUCT, 'hde', [elephantdb.ttypes.HostsDownException, None], None, ),  # 2
    (3, TType.STRUCT, 'dnle', [elephantdb.ttypes.DomainNotLoadedException, None], None, ),  # 3
)
...
multiGet_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'domain', 'UTF8', None, ),  # 1
    (2, TType.SET, 'key', (TType.STRING, 'BINARY', False), None, ),  # 2
)
...
multiGet_result.thrift_spec = (
    (0, TType.MAP, 'success', (TType.STRING, 'BINARY', TType.STRUCT, [elephantdb.ttypes.Value, None], False), None, ),  # 0
    (1, TType.STRUCT, 'dnfe', [elephantdb.ttypes.DomainNotFoundException, None], None, ),  # 1
    (2, TType.STRUCT, 'hde', [elephantdb.ttypes.HostsDownException, None], None, ),  # 2
    (3, TType.STRUCT, 'dnle', [elephantdb.ttypes.DomainNotLoadedException, None], None, ),  # 3
)
...
class directMultiGet_args(object):
    """
    Attributes:
     - domain
     - key
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(directMultiGet_args)
directMultiGet_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'domain', 'UTF8', None, ),  # 1
    (2, TType.SET, 'key', (TType.STRING, 'BINARY', False), None, ),  # 2
)
...
class directMultiGet_result(object):
    """
    Attributes:
     - success
     - dnfe
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(directMultiGet_result)
directMultiGet_result.thrift_spec = (
    (0, TType.MAP, 'success', (TType.STRING, 'BINARY', TType.STRUCT, [elephantdb.ttypes.Value, None], False), None, ),  # 0
    (1, TType.STRUCT, 'dnfe', [elephantdb.ttypes.DomainNotFoundException, None], None, ),  # 1
    (2, TType.STRUCT, 'hde', [elephantdb.ttypes.HostsDownException, None], None, ),  # 2
    (3, TType.STRUCT, 'dnle', [elephantdb.ttypes.DomainNotLoadedException, None], None, ),  # 3
