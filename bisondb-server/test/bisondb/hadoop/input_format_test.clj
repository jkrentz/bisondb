(ns bisondb.hadoop.input-format-test
  (:use midje.sweet
        bisondb.test.common
        bisondb.test.keyval)
  (:import [bisondb Utils]
           ...
           [bisondb.hadoop BisonInputFormat BisonInputFormat$Args]
...
(defn read-domain [dpath]
  (let [input-format (BisonInputFormat.)
        args (BisonInputFormat$Args. dpath)
        conf (doto (JobConf.)
               (Utils/setObject BisonInputFormat/ARGS_CONF args))
