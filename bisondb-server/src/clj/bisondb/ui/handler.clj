...
(defn domain [conf-map id domain]
  (template (str "BisonDB | " id " | " domain)
            [:ul.breadcrumb
             [:li (link-to "/" "Cluster") [:span.divider "/"]]
