...
public class Status implements org.apache.thrift.TBase<Status, Status._Fields>, java.io.Serializable, Cloneable, Comparable<Status> {
  ...
  public Status(Status other) {
    if (other.is_set_domain_statuses()) {
      Map<String,DomainStatus> __this__domain_statuses = new HashMap<String,DomainStatus>(other.domain_statuses.size());
  ...
  public int compareTo(Status other) {
    ...
    lastComparison = Boolean.valueOf(is_set_domain_statuses()).compareTo(other.is_set_domain_statuses());
    if (lastComparison != 0) {
