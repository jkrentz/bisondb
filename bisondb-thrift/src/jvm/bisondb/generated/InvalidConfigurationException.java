...
public class InvalidConfigurationException extends TException implements org.apache.thrift.TBase<InvalidConfigurationException, InvalidConfigurationException._Fields>, java.io.Serializable, Cloneable, Comparable<InvalidConfigurationException> {
  ...
  public InvalidConfigurationException(InvalidConfigurationException other) {
    ...
    if (other.is_set_mismatched_domains()) {
      List<String> __this__mismatched_domains = new ArrayList<String>(other.mismatched_domains);
  ...
  public void unset_port_changed() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __PORT_CHANGED_ISSET_ID);
  }
  ...
  public boolean is_set_port_changed() {
    return EncodingUtils.testBit(__isset_bitfield, __PORT_CHANGED_ISSET_ID);
  }

  public void set_port_changed_isSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __PORT_CHANGED_ISSET_ID, value);
  }
  ...
  public void unset_hosts_changed() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __HOSTS_CHANGED_ISSET_ID);
  }
  ...
  public boolean is_set_hosts_changed() {
    return EncodingUtils.testBit(__isset_bitfield, __HOSTS_CHANGED_ISSET_ID);
  }

  public void set_hosts_changed_isSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __HOSTS_CHANGED_ISSET_ID, value);
  }
  ...
  public int compareTo(InvalidConfigurationException other) {
    ...
    lastComparison = Boolean.valueOf(is_set_mismatched_domains()).compareTo(other.is_set_mismatched_domains());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(is_set_port_changed()).compareTo(other.is_set_port_changed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(is_set_hosts_changed()).compareTo(other.is_set_hosts_changed());
    if (lastComparison != 0) {
      return lastComparison;
    }
