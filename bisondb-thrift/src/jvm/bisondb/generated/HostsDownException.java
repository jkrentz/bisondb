...
public class HostsDownException extends TException implements org.apache.thrift.TBase<HostsDownException, HostsDownException._Fields>, java.io.Serializable, Cloneable, Comparable<HostsDownException> {
  ...
  public int compareTo(HostsDownException other) {
    ...
    lastComparison = Boolean.valueOf(is_set_hosts()).compareTo(other.is_set_hosts());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.hosts = new ArrayList<String>(_list28.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HostsDownException struct) throws org.apache.thrift.TException {
      ...
      if (struct.hosts != null) {
        oprot.writeFieldBegin(HOSTS_FIELD_DESC);
        {
          ...
          for (String _iter31 : struct.hosts)
          {
  ...
  private static class HostsDownExceptionTupleScheme extends TupleScheme<HostsDownException> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, HostsDownException struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (String _iter32 : struct.hosts)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, HostsDownException struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.hosts = new ArrayList<String>(_list33.size);
        for (int _i34 = 0; _i34 < _list33.size; ++_i34)
        {
          String _elem35;
          _elem35 = iprot.readString();
          struct.hosts.add(_elem35);
        }
      }
      struct.set_hosts_isSet(true);
    }
