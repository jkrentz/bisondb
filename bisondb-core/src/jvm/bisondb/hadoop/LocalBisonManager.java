...
public class LocalBisonManager {
    public static final String TMP_DIRS_CONF = "bisondb.local.tmp.dirs";
    ...
    public LocalBisonManager(FileSystem fs, DomainSpec spec, List<String> tmpDirs, Reporter reporter) throws IOException {
    ...
    public LocalBisonManager(FileSystem fs, DomainSpec spec, List<String> tmpDirs) throws IOException {
        this(fs, spec, tmpDirs, null);
    }

    /**
     * Creates a temporary directory, downloads the remotePath (tied to the FS), and returns it. If
     * remotePath is null or doesn't exist, creates an empty local bison and closes it.
     * @param id
     * @param remotePath
     * @return
